<header>
        <h1 class="logo_container">
            <a href="index.php" aria-label="">
                <svg class="icon icon_logo" role="img" aria-label="SKYGREEN logo" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 152.23 50.76" style="enable-background:new 0 0 152.23 50.76;" xml:space="preserve">
                    <style type="text/css">
                        .st0{fill:#F2F2F2;}
                    </style>
                    <g>
        ...
        <div class="icon_container">
            ...
            <svg class="icon icon_menu" role="img" aria-label="menu icon" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="0 0 48.07 45.61" style="enable-background:new 0 0 48.07 45.61;" xml:space="preserve">
                <style type="text/css">
                    .st2{fill:none;stroke:#F2F2F2;stroke-width:7;stroke-linecap:round;stroke-miterlimit:10;}
                </style>
        ...
        <aside id="shopping">
            <ul class="products_container"></ul>
        </aside>
    </header>