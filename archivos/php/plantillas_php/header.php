<header>
        ...
        <div class="icon_container">
            <svg class="icon icon_shopping" role="img" aria-label="shopping icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 48.04 48.26" style="enable-background:new 0 0 48.04 48.26;" xml:space="preserve">
                <style type="text/css">
                    .st1{fill:none;stroke:#F2F2F2;stroke-width:7;stroke-linecap:round;stroke-miterlimit:10;}
                </style>
            ...
            <svg class="icon icon_menu" role="img" aria-label="menu icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"viewBox="0 0 48.07 45.61" style="enable-background:new 0 0 48.07 45.61;" xml:space="preserve">
                <style type="text/css">
                    .st2{fill:none;stroke:#FFFFFF;stroke-width:7;stroke-linecap:round;stroke-miterlimit:10;}
                </style>
                <line class="st2 line1" x1="3.86" y1="41.99" x2="44.15" y2="41.99"/>
                <line class="st2 line2" x1="3.86" y1="22.85" x2="44.15" y2="22.85"/>
                <line class="st2 line3" x1="3.86" y1="3.7" x2="44.15" y2="3.7"/>
            </svg>
        </div>
        <nav id="menu">
            MENU
